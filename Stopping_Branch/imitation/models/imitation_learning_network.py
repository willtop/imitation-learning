...
DROPOUT_VEC_TRAIN = [1.0] * 8 + [0.7] * 2 + [0.5] * 2 + [0.5] * 1 + [0.5, 1.] * 6 # Modified last number to include dropout for stopping branch as well
...
class Network(object):
    ...
    def dropout(self, x):
        ...
        # print(self._dropout_vec)
        # print(self._count_dropouts)
...
def load_imitation_learning_network(input_image, input_data, mode):
    ...
    with tf.name_scope('Network'):  # for a nicer Tensorboard graph, use: `with tf.variable_scope('Network'):`
        ...
        branch_config = [
            ...
            [ilc.TGT_STEER, ilc.TGT_GAS, ilc.TGT_BRAKE],
            [ilc.TGT_STEER, ilc.TGT_GAS, ilc.TGT_BRAKE],
            [ilc.TGT_STEER, ilc.TGT_GAS, ilc.TGT_BRAKE], # Add stopping branch
            [ilc.TGT_SPEED],
        ]
