...
def model(features, labels, mode, loss_weights):
    ...
    pred_all_branches = tf.stack(branches[:5], axis=1)  # shape: (?, 5, 3), stack along number of branches
    ...
    if mode in [tf.estimator.ModeKeys.TRAIN, tf.estimator.ModeKeys.EVAL]:
        ...
        with tf.name_scope('predictions'):
            ...
            # high_level_cmds are [2, 3, 4, 5, 6]; convert to 0-indexing
            ...
            # While pred_all_branches holds the predictions for each of the 5 branches,
